<header class="navbar navbar-expand-lg navbar-light bg-light">
                        <div class="container-fluid">
							...
							<li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{route('appartment')}}" role="button" aria-expanded="false">Appartments</a>
                                ...
                                <li><a class="dropdown-item" href="{{route('appartment')}}">All Appartments</a></li>
                                        </ul>
                            </li>
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="{{route('house')}}">All Houses</a></li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('show_contact')}}">Contact Us</a>
                                    </li>
                                </ul>
